#ifndef NCNN_INCLUDE_GUARD_ncnn_id_h
#define NCNN_INCLUDE_GUARD_ncnn_id_h
namespace ncnn_proto_id {
const int LAYER_data = 0;
const int BLOB_data = 0;
const int LAYER_conv1 = 1;
const int BLOB_conv1 = 1;
const int LAYER_relu_conv1 = 2;
const int BLOB_relu_conv1 = 2;
...
const int BLOB_fire9_relu_squeeze1x1 = 70;
const int LAYER_splitncnn_7 = 64;
const int BLOB_fire9_relu_squeeze1x1_splitncnn_0 = 71;
const int BLOB_fire9_relu_squeeze1x1_splitncnn_1 = 72;
const int LAYER_fire9_expand1x1 = 65;
const int BLOB_fire9_expand1x1 = 73;
const int LAYER_fire9_relu_expand1x1 = 66;
const int BLOB_fire9_relu_expand1x1 = 74;
const int LAYER_fire9_expand3x3 = 67;
const int BLOB_fire9_expand3x3 = 75;
const int LAYER_fire9_relu_expand3x3 = 68;
const int BLOB_fire9_relu_expand3x3 = 76;
const int LAYER_fire9_concat = 69;
const int BLOB_fire9_concat = 77;
const int LAYER_drop9 = 70;
const int BLOB_drop9 = 78;
const int LAYER_conv10 = 71;
const int BLOB_conv10 = 79;
const int LAYER_activation0 = 72;
const int BLOB_activation0 = 80;
const int LAYER_pooling0 = 73;
const int BLOB_pooling0 = 81;
const int LAYER_flatten = 74;
const int BLOB_flatten = 82;
const int LAYER_softmax_label = 75;
const int BLOB_softmax_label = 83;
const int LAYER_softmax = 76;
const int BLOB_softmax = 84;
} // namespace ncnn_proto_id
#endif // NCNN_INCLUDE_GUARD_ncnn_id_h
